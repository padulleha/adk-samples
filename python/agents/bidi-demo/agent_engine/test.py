        ...
        for query in queries:
            ...
            while True:
                ...
                if isinstance(event_data, dict) and "actions" in event_data:
                    ...
                    if "requested_tool_confirmations" in event_data.get("actions", {}):
        ...
        while True:
            ...
            while True:
                ...
                if (
                    ...
                    and "requested_tool_confirmations" in event_data.get("actions", {})
                ):
                    del event_data["actions"]["requested_tool_confirmations"]
...
def main():
    parser = argparse.ArgumentParser(description="Test the deployed bidi-demo agent")
    parser.add_argument(
